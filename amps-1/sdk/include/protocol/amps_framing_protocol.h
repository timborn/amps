...
///
extern "C"
int amps_string_framing_protocol_allocate_segment(amps_message_buffer_allocate_function allocate_,amps_message_segment *pSegment_,size_t size_);
extern "C"
...
///
extern "C"
int amps_websocket_framing_protocol_allocate_segment(amps_message_buffer_allocate_function allocate_,amps_message_segment *pSegment_,size_t size_);
extern "C"
...
extern "C"
int amps_websocket_framing_protocol_handshake(const char *pBuffer_,size_t length_,amps_protocol_handshake_response *pResponse_);
...
inline int amps_protocol_default_allocate_segment(amps_message_buffer_allocate_function allocate_,amps_message_segment *pSegment_,size_t size_)
{
