...
struct amps_transport_connect_client_params
{
  ...
  int                           is_stream_compression; // set to true if stream compressed is desired
...
typedef int (*amps_transport_enable_client_function)(amps_transport_context,amps_transport_client_handle);
typedef int (*amps_transport_disable_client_function)(amps_transport_context,amps_transport_client_handle);
typedef int (*amps_transport_disconnect_client_function)(amps_transport_context,amps_transport_client_handle);
typedef int (*amps_transport_destroy_client_function)(amps_transport_context,amps_transport_client_handle);
typedef int (*amps_transport_request_client_send_is_ready_function)(amps_transport_context,amps_transport_client_handle);
